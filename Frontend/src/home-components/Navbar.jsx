        ...
        <div className="navbar bg-black text-white bg-opacity-25">
            <nav className="flex justify-between items-center p-4">
                ...
                <ul className='hidden sm:flex space-x-8 font-mono font-extrabold md:p-2 md:text-xl'>
                    ...
                    <li><a href="#" className='text-white hover:bg-white hover:text-black hover:rounded-full transition-all duration-200 md:p-2 md:px-5' onClick={() => { setLink('/Tutorials') }}>Project Details</a></li>
